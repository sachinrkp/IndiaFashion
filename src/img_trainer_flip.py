...
from utils.common_utils import image_transform, image_transform_flip, get_accuracy, calculate_metrics
...
# Dataloaders
train_set = EthnicFinderDataset(metadata_file=config.train_file, mode='train', transform=image_transform_flip)
