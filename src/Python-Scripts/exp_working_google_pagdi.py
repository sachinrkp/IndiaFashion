...
def get_images_from_utsavfashion(wd, delay):
    ...
    url = "https://www.google.com/search?q=men+pagdi&tbm=isch&ved=2ahUKEwiyk4rCvNyAAxUJKcAKHblMCLEQ2-cCegQIABAA&oq=men+pagdi&gs_lcp=CgNpbWcQAzIECCMQJzIGCAAQCBAeMgYIABAIEB46CAgAEIAEELEDOgUIABCABDoLCAAQgAQQsQMQgwE6BwgAEIoFEEM6BAgAEAM6BAgAEB46BggAEAUQHlDUDViAJ2CMKWgAcAB4AYABwwOIAZcMkgEJNC40LjEuMC4xmAEAoAEBqgELZ3dzLXdpei1pbWfAAQE&sclient=img&ei=QEnaZLLzNonSgAa5maGICw&bih=739&biw=1536&rlz=1C1ONGR_enIE1057IE1060"
    wd.get(url)
...
for i, url in enumerate(metadata):
    download_image("images/crop_samples/", url["image_url"], str(START_INDEX + i) + ".jpg")
