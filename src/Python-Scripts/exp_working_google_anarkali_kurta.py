...
def get_images_from_utsavfashion(wd, delay):
    ...
    url = "https://www.google.com/search?q=indian+ethnic+anarkali+dress&tbm=isch&ved=2ahUKEwi_hfqlxNyAAxUBU0EAHdT3DMkQ2-cCegQIABAA&oq=indian+ethnic+anarkali+dress&gs_lcp=CgNpbWcQAzoECCMQJ1AAWOUPYN8WaABwAHgAgAFCiAH7ApIBATeYAQCgAQGqAQtnd3Mtd2l6LWltZ8ABAQ&sclient=img&ei=aVHaZP-sGIGmhbIP1O-zyAw&bih=739&biw=1536&rlz=1C1ONGR_enIE1057IE1060"
    wd.get(url)
            ...
            try:
                ...
                if image_url and 'http' in image_url:
                    ...
                    metadata.append({
                        ...
                        "brand": "N/A",
                        "product_title": "N/A",
                        "class_label": "women_anarkali_kurta"
                    })
...
for i, url in enumerate(metadata):
    download_image("images/anarkali_images/", url["image_url"], str(START_INDEX + i) + ".jpg")
