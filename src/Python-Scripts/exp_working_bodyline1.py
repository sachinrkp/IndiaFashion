...
def get_images_from_utsavfashion(wd, delay, max_images):
    ...
    url = "https://www.bodylinestore.com/pages/accessories/safa-wedding-turban"
    wd.get(url)
    ...
    while images_collected < max_images:
        ...
        products = wd.find_elements(By.CLASS_NAME, "image")
...
metadata = []
urls = get_images_from_utsavfashion(wd, 1, 23)
